...
/*    @Test
    public void testCreatePerson_Created() throws Exception {
        ...
        when(personService.personExist(person)).thenReturn(false);
    ...
    public void testCreatePerson_Conflict() throws Exception {
        when(personService.personExist(person)).thenReturn(true);
    ...
    @Test
    public void testUpdatePerson_Created() throws Exception {
        personList.add(person);

        when(personService.personExist(person)).thenReturn(false);
        when(personService.updatePerson(person)).thenReturn(personList);
    ...
    public void testDeletePerson_Ok() throws Exception {
        when(personService.deletePerson("Jerome", "Cheviet")).thenReturn(true);
    ...
    public void testDeletePerson_Conflict() throws Exception {
        when(personService.deletePerson("Jerome", "Cheviet")).thenReturn(false);
